...
- marca a publicação como `partial` e a execução como `blocked_coverage` porque
  a coleta foi interrompida antes do esgotamento observável, não pela
  divergência com a Stilingue;
