...
| [`product-catalog`](plugins/io-social-media/skills/product-catalog/SKILL.md) | `/io-social-media:product-catalog` | Catálogo de produtos por marca ("o que é o produto e como a marca fala"): marcas (voz/mensagens/público), produtos, fotos + aba Produtos do painel. |
